...
## Project Structure
    ...
    ├── testapiautosetting_123488  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123488`
...
2. Clone this repo and `cd testapiautosetting_123488`
